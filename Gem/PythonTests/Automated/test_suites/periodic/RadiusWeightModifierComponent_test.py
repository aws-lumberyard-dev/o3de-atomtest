...
Tests the Radius Weight component inside the Editor.
...
class TestAutomation(TestAutomationBase):
    ...
    def test_RadiusWeightModifierComponent_DisplaysCorrectExposureValues(
        ...
        Tests that the Radius Weight Modifier component functionality is maintained within the Editor.
        """
        golden_screenshots = [
        ...
        test_screenshots = [
            os.path.join(engine_root, project, DEFAULT_SUBFOLDER_PATH,
        ...
        hydra.launch_and_validate_results(
            ...
            TEST_DIRECTORY,
            editor,
            "RadiusWeightModifierComponent_test_case.py",
