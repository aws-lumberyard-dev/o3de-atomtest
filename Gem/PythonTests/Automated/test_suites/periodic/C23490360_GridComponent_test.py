...
class TestAutomation(TestAutomationBase):
    ...
    @pytest.mark.test_case_id('C23490360')
    def test_C23490360_GridComponent(self, request, workspace, editor, project, launcher_platform):
        golden_screenshot = os.path.join(os.path.dirname(__file__), 'GoldenImages', 'Windows', "GridComponent.ppm")
        ...
        hydra.launch_and_validate_results(
            ...
            TEST_DIRECTORY,
            editor,
            "C23490360_GridComponent_test_case.py",
